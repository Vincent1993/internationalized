...
> 基于 [`Intl.NumberFormat`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat) 的强大数字格式化组件库，支持多种格式化样式、智能规则匹配和异常值自动处理。
